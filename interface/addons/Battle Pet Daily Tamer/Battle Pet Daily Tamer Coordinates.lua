...
--[[	DailyInfo describes the dailies. It's indexed by the questID of each daily quest.
	...
	[questID] = {
		...
		[3] = continent (1=kalimdor, 2=EK, 3=outland, 4=northrend, 5=maelstrom, 6=pandaria, 7=draenor, 8=broken isles, 0=other)
...
tamer.DailyInfo = {
	...
	[42064]={105841,nil,8,nil,nil,1024,0.000,0.000,1,25,1881}, -- It's Illid... Wait (Lil'idan)
