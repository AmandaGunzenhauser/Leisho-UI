...
-- Menus\TeamMenus.lua
	...
	L["When your new target has a saved team not already loaded, and the target panel isn't on screen, display a popup asking if you want to load the team.\n\nThis is only for the first interaction with a target. You can always load a target's team from the target panel."] = "新的目標有已儲存的隊伍，但是卻未載入，而且畫面上沒有出現目標面板時，顯示彈出訊息來詢問是否要載入隊伍。\n\n只有第一次和目標互動時才會提示載入，但總是可以從目標面板載入目標的隊伍。"
	...
	L["Prompt every time you interact with a target with a saved team not already loaded, instead of only the first time."] = "每次和目標互動，但卻沒有載入已儲存的隊伍時都要提示，而不是只有第一次。"
	L["When you mouseover a new target that has a saved team not already loaded, immediately load it.\n\nThis is only for the first interaction with a target. You can always load a target's team from the target panel."] = "滑鼠指向一個新的目標，但卻沒有載入已儲存的隊伍時，立即載入。\n\n只有第一次和目標互動時才會提示載入，但總是可以從目標面板載入目標的隊伍。"
	...
	L["On Target Only"] = "選為目標才載入"
	L["Auto load upon targeting only, not mouseover.\n\n\124cffff4040WARNING!\124r This is not recommended! It can be too late to load pets if you target with right click!"] = "只有選取為目標時才自動載入，滑鼠指向不載入。\n\n\124cffff4040警告!\124r 不建議使用! 如果用滑鼠右鍵來選取為目標，會來不及載入寵物。"
...
-- Cards\PetCard.lua
	...
	L["%d Teams"] = "%d 組隊伍"
	L["Teams"] = "隊伍"
	L["The number of Rematch teams that includes this pet."] = "包含這個寵物的隊伍數目。"
...
-- Panels\LoadoutPanel.lua
	L["Target has a saved team"] = "目標已有儲存的隊伍"
	L["Load"] = "載入"
	L["Load the team saved for this target."] = "載入這個目標已儲存的隊伍"
	L["This target has no saved team"] = "目標沒有已儲存的隊伍"
	L["Save the currently loaded pets to this target."] = "儲存目前已經載入的寵物，供這個目標使用。"
...
-- Panels\QueuePanel.lua
	...
	L["Fill Queue"] = "加入等候區"
	L["Fill the leveling queue with one of each species that can level from the filtered pet browser, and for which you don't have a level 25 already."] = "將已過濾的寵物瀏覽器中，可以戰鬥且沒有一個滿等級25的寵物，加入升級等候區。"
	L["Fill Queue More"] = "加入更多到等候區"
	L["Fill the leveling queue with one of each species that can level from the filtered pet browser, regardless whether you have any at level 25 already."] = "將已過濾的寵物瀏覽器中，可以戰鬥的寵物加入升級等候區，不論是否其中已經有等級25。"
	L["Empty Queue"] = "清空等候區"
...
-- Panels\MiniPanel.lua
	L["This target has a saved team"] = "目標有已儲存的隊伍"

-- Panels\OptionPanel.lua
	L["All Options"] = "所有選項"
	L["Team & Targeting Options"] = "隊伍 & 目標選項"
	L["Auto load upon targeting only, not mouseover.\n\n\124cffff4040WARNING!\124r This is not recommended! It can be too late to load pets if you target with right click!"] = "只有選取為目標時才自動載入，滑鼠指向不載入。\n\n\124cffff4040警告!\124r 不建議使用! 如果用滑鼠右鍵來選取為目標，會來不及載入寵物。"
	L["Always Show When Targeting"] = "選取目標時總是顯示"
	L["Regardless whether a target's team is already loaded, show the Rematch window when you target something with a saved team."] = "不論是否已經載入目標的隊伍，選取的目標有已儲存的隊伍時，顯示戰寵送作隊視窗。"
	L["Show After Pet Battle"] = "寵物對戰結束後顯示"
	L["Show the Rematch window after leaving a pet battle."] = "對戰結束後顯示寵物送作隊視窗"
	...
	L["Hide Targets Below Teams"] = "隱藏隊伍的其他目標"
	L["Hide the target name that appears beneath a team that is not named the same as its target."] = "隱藏隊伍當前目標以外的目標名稱。"
	...
	L["Show Notes Upon Targeting"] = "顯示目標的註記"
	L["When your target has a saved team with notes, automatically display and lock the notes."] = "選擇的目標有已經儲存的隊伍和註記時，自動顯示並且鎖定註記。"
...
-- Widgets\TeamTabs.lua
	...
	L["Are you sure you want to sort teams alphabetically in this tab?\n\nThe custom sort order will be lost and cannot be undone."] = "這個標籤頁中的隊伍是否要依照字母排序?\n\n如此一來便會移除自訂排序，而且無法復原。"
	L["While checked, you can rearrange the order of teams within this tab."] = "勾選時，可以重新排列這個標籤頁中的隊伍。"
...
-- Dialogs\Save.lua
	L["Target For This Team"] = "這個隊伍的目標"
	L["A target stored in a team is used to decide which team to load when you return to that target.\n\nYou can save an unlimited number of teams to fight a target, but a target can only be saved in one team."] = "再次和遇到目標時，會使用隊伍中所儲存的目標來決定要載入哪個隊伍。\n\n每個隊伍只能儲存一個目標，但可以儲存無限數量的隊伍與同一個目標對戰。"
	L["Save As.."] = "另存為..."
...
-- Dialogs\Preferences.lua
	...
	L["Leveling Preferences For %s:"] = "%s 的升級偏好設定:"
	L["Expected damage taken"] = "預期受到的傷害"
	...
	L["  For %s pets: \124cffffd200%d"] = " - %s 寵物: \124cffffd200%d"
...
-- Dialogs\Share.lua
	...
	L["%s%d\124r have a name or target already used."] = "%s%d\124r 已有名稱，或目標已經被使用。"
	...
	L["%s%s\124r has sent you a team named \"%s\" (for %s)."] = "%s%s\124r 傳送給你一個隊伍，名稱為 \"%s\" (目標是 %s)。"
	L["%s%s\124r has sent you a team for %s."] = "%s%s\124r 傳送給你一個隊伍，目標是 %s。"
